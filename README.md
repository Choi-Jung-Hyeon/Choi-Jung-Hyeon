...
<img src="https://komarev.com/ghpvc/?username=Choi-Jung-Hyeon&style=flat-square&color=58A6FF" alt="views"/>
...
- ⚖️ **SKKUDING** — Backend & Frontend for [Codedang](https://github.com/skkuding/codedang), SKKU's Online Judge
- 🔬 **LG AI Research (Team Lead)** — training-free AI-image detection
- 🧠 **SKKU NLP Lab** — RAG · LLM pipelines, RL/DPO seminars
- 🏗️ **Hyscape Intern** — air-gapped NAS + LLM automation pipeline
...
|---------|-------------|-------|------|
| ⚖️ [**Codedang**](https://github.com/skkuding/codedang) | SKKU Online Judge — resolved N+1 bottlenecks, type-safe REST API | `NestJS` `Prisma` `MySQL` | BE / FE |
...
| 🖼️ [**AI Image Detection**](https://github.com/Choi-Jung-Hyeon/2025S_IACP) | Training-free detection w/ LG AI Research — no retraining cost | `Python` `PyTorch` | **Team Lead** |
| 🕵️ [**Deepfake Detection**](https://github.com/Choi-Jung-Hyeon/2025F_DFAI) | NFS competition — mixed clean/degraded dataset, preprocessing | `Python` `PyTorch` | Data Lead |
...
| 🏗️ [**Hyscape Automation**](https://github.com/Choi-Jung-Hyeon/2025F_HYSCAPE) | Air-gapped NAS + LLM data-automation pipeline | `Python` `AWS` | Intern · BE/Infra |
...
<img src="https://github-readme-stats.vercel.app/api?username=Choi-Jung-Hyeon&show_icons=true&theme=github_dark&include_all_commits=true&hide_border=true&bg_color=0d1117" height="165"/>
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Choi-Jung-Hyeon&layout=compact&theme=github_dark&hide_border=true&bg_color=0d1117&langs_count=8" height="165"/>

</div>

<br/>

## 🏛️ Organizations & Research
...
| ⚖️ [**@skkuding**](https://github.com/skkuding) | Codedang BE/FE · code-review culture · infra study |
